...
def add_course(name: str, student_grades: str = typer.Argument(..., help="Student grades as name:grade pairs (e.g., Alice:90,Bob:85)")):
    ...
    grades_dict = {pair.split(":")[0]: float(pair.split(":")[1]) for pair in student_grades.split(",")}
...
@app.command()
def update_student(name: str, grades: str = typer.Argument(..., help="Comma-separated new grades (e.g., 95,90,88)")):
